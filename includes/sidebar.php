...
<li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Services</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-file-o"></i><a href="add-computer.php">Add Services</a></li>
                            <li><i class="menu-icon fa fa-file-o"></i><a href="manage-computer.php">Manage Services</a></li>
                        </ul>
                    </li>
